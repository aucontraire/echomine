...
**Tests**: The examples below include test tasks. Per the constitution, TDD is MANDATORY - tests MUST be written first and verified to fail before implementation begins.
